                              ...
                              <div className="message-box">
                                ...
                                <div className="d-flex align-items-center justify-content-end message-footer text-muted text-right pt-2 pr-2">
                                  { item.messageDate === null ? (
                                    ...
                                    <div>
                                      {chat_detail.username ? `By ${chat_detail.username} - ` : null }
                                      {moment(item.messageDate).format("hh:mm")}
                                    </div>
                                  ) }
                                  { false ? (
                              ...
                              <div className="message-box">
                                ...
                                <div className="d-flex align-items-center justify-content-end message-footer text-muted text-right pt-2 pr-2">
                                  { item.messageDate === null ? (
                                    ...
                                    <div>
                                      {item.messageStatus ? `${item.messageStatus} - ` : null}
                                      {item.admin_user.username ? `By ${item.admin_user.username.toUpperCase()} - ` : null }
                                      {moment(item.messageDate).format("hh:mm")}
                                    </div>
                                  )}
                                  { false ? (
